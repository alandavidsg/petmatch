...
import { ArrowLeft, Utensils, Syringe, Stethoscope, CreditCard, Loader2, Building2 } from 'lucide-react';
    ...
    <main className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-lg mx-auto px-6 py-10">
        ...
        <div className="text-center mb-10">
          <div className="flex justify-center mb-4"><div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center"><CreditCard size={32} className="text-orange-500" /></div></div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            { icon: <Utensils size={22} className="text-orange-500" />, amount: '$1.000', label: 'Un día de comida' },
            { icon: <Syringe size={22} className="text-orange-500" />, amount: '$5.000', label: 'Vacuna básica' },
            { icon: <Stethoscope size={22} className="text-orange-500" />, amount: '$10.000', label: 'Consulta veterinaria' },
          ].map((item) => (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <p className="text-sm font-medium text-[#1a1a2e] mb-4 flex items-center gap-2">
            <Building2 size={16} className="text-gray-500" /> Transferencia bancaria
          </p>
